...
- Purpose of this task is to detect and localize new items in bagging area

## Techniques used
- Motion detection is done using Open CV background subtractor, comparing a previous frame with current
