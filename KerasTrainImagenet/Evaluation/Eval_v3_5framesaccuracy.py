...
def eval ( model, target_size = 150, subtractMean=0.0, datasrc = "selfCreatedGoogle", test = False ):
    ...
    batch_size=128
    trainDataGen = as_v4.AugSequence ( target_size=extended_target_size, crop_range=1, allow_hor_flip=False, batch_size=batch_size, subtractMean=subtractMean, datasrc=datasrc, test=test )
