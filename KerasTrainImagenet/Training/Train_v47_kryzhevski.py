...
def trainModel( model = None ):
    ...
    #model.fit_generator ( dataGen, steps_per_epoch=1, epochs=full_epochs, verbose=2, validation_data=vldDataGen, validation_steps=len(vldDataGen), callbacks=[callback_earlystop] )
    #model.fit_generator ( dataGen, steps_per_epoch=len(dataGen), epochs=full_epochs, verbose=2 )
    #model.fit_generator ( dataGen, steps_per_epoch=1, epochs=full_epochs, verbose=2 )
