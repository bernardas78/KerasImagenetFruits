...
#
# To run:
#   model = t_det_v62.trainModel( epochs=30, stepsPerEpochFull=False, stepsPerEpoch=5)
#   model = t_det_v62.trainModel(model, epochs=50, stepsPerEpochFull=False, stepsPerEpoch=5)
#   model = t_det_v62.trainModel(model, epochs=10)
