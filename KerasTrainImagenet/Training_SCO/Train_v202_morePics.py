...
#
# To run:
#   model = t_sco_v202.trainModel(epochs=30)
#   model = t_sco_v202.trainModel(epochs=30, train_d2=True)
#   model = t_sco_v202.trainModel(epochs=200, train_d1=True, train_d2=True)
#   model = load_model("D:\\Startup\\models\\model_v202.h5", custom_objects={'top_5':m_v11.top_5})
#   model = load_model("D:\\Startup\\models\\model_v202_11classes.h5", custom_objects={'top_5':m_v11.top_5})
...
def trainModel( epochs = 1, train_d1=False, train_d2=False):
    ...
    model = m_v11.prepModel (train_d1=train_d1, train_d2=train_d2, Softmax_size=21)
    ...
    model.fit_generator ( dataGen, steps_per_epoch=len(dataGen), epochs=epochs, verbose=2, validation_data=vldDataGen, 
                         validation_steps=len(vldDataGen), callbacks=[callback_earlystop] )
